...
object Model {
    data class Response(private val drink: List<Drinks>)


    data class Drinks(
            private val idDrink: String? = null,
            private val strDrink: String? = null,
            private val strCategory: String? = null,
            private val strAlcoholic: String? = null,
            private val strGlass: String? = null,
